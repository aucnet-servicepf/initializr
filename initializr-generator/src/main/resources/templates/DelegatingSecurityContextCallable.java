...
public final class DelegatingSecurityContextCallable<V> implements Callable<V> {
    ...
    private RequestAttributes originRequestAttributes;
	...
	public V call() throws Exception {
		...
		this.originRequestAttributes = RequestContextHolder.getRequestAttributes();
